...
function Topbar() {
  ...
  // tim kiem san pham theo db co san
  ...
  return (
    <Header
      style={{ background: "#DB2523" }}
      className={styles.header}
    >
      <div className="">
      <NavLink className={styles.navlink} to="/home" activeStyle>
      <NavLink className={styles.navlink} to="/home" activeStyle>
      <img style={{ color: "#000000", fontSize: 15, height: 55, cursor: "pointer" , borderRadius:'5px' }} src="https://i.ibb.co/wgyLgvW/7884402.jpg" onClick={() => handleLink("/home")}></img>
        </NavLink>
        </NavLink>    
      </div>
