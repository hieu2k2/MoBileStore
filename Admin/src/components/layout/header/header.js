...
function Topbar() {
  ...
  return (
    ...
    >
      <div >
        <Row className="header" style={{ background: "#DB2223", top: 0, position: 'fixed', left: 0, display: 'flex', width: '100%', padding: 0, zIndex: 2, justifyContent: 'center', alignItems: 'center' }}>
          <Col span={10}>
            <div style={{ position: 'relative', display: 'flex', paddingTop: 3, paddingBottom: 3, alignItems: "center", marginLeft: 8 }}>
              ...
              >
                <Col style={{ paddingLeft: 65 }}>
                  <a href="#">
                    <img style={{ height: 44, width: 40, borderRadius:'5px' }} className="logo" alt="" src="https://i.ibb.co/wgyLgvW/7884402.jpg" />
                  </a>
                </Col>
              </Row>
            </div>
